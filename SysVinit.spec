...
# Source0-md5:	2bf73055b0e54b5d98c1fff98204f248
...
%lang(de) %{_mandir}/de/man5/initscript.5*
%lang(de) %{_mandir}/de/man5/inittab.5*
%lang(de) %{_mandir}/de/man8/bootlogd.8*
%lang(de) %{_mandir}/de/man8/init.8*
%lang(de) %{_mandir}/de/man8/logsave.8*
%lang(de) %{_mandir}/de/man8/runlevel.8*
...
%lang(fr) %{_mandir}/fr/man5/initscript.5*
%lang(fr) %{_mandir}/fr/man5/inittab.5*
%lang(fr) %{_mandir}/fr/man8/bootlogd.8*
...
%lang(pt) %{_mandir}/pt/man5/initctl.5*
%lang(pt) %{_mandir}/pt/man5/initscript.5*
%lang(pt) %{_mandir}/pt/man5/inittab.5*
%lang(pt) %{_mandir}/pt/man8/bootlogd.8*
%lang(pt) %{_mandir}/pt/man8/logsave.8*
%lang(pt) %{_mandir}/pt/man8/runlevel.8*
%lang(pt) %{_mandir}/pt/man8/shutdown.8*
...
%lang(de) %{_mandir}/de/man1/readbootlog.1*
%lang(de) %{_mandir}/de/man1/wall.1*
%lang(de) %{_mandir}/de/man8/killall5.8*
...
%lang(pt) %{_mandir}/pt/man1/readbootlog.1*
%lang(pt) %{_mandir}/pt/man1/wall.1*
%lang(pt) %{_mandir}/pt/man8/fstab-decode.8*
%lang(pt) %{_mandir}/pt/man8/killall5.8*
%lang(pt) %{_mandir}/pt/man8/pidof.8*
